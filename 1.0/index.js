 ...
 *
 * @default
 * @type {{textArea: HTMLTextAreaElement, saveButton: HTMLButtonElement, clearAreaButton: HTMLButtonElement, clearListButton: HTMLButtonElement, listNotes: HTMLElement, tagP: HTMLCollectionOf<HTMLElementTagNameMap["p"]>}}
 */
const docObj = {
...
const bufferTagNote = (function () {
   ...
   *
   * @private
   * @type {(string|Object)} - хранит переданну коллекцию DOM элемента
   */
  let _bufferTag = '';
...
class SwitchClick {
  constructor(buttonEvent) {
    ...
    /**
     * @private
     * @type {boolean} - нужен для переключения одинарного и двойного клика по записи
     */
    this._firing = false;
    /**
     * @private
     * @type {number} - id таймера setTimeout
     */
    this._timer = 0;
  }
